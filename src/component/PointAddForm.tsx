            ...
            <Modal.Body>
                <Form onSubmit={handleOnSubmit} validated={isFormValidate} noValidate>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="number" required value={points} onChange={handleOnPoints.bind(this)} />
                        <FormControl.Feedback type='invalid'>
                            <p className="text-danger fw-bold">Please Enter Number Of Points</p>
                        </FormControl.Feedback>
                    </Form.Group>
                    <Button className='mb-0 float-end m-1 mt-2' variant="secondary" onClick={onFormClose} >Close</Button>
